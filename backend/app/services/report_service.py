...
<head>
    ...
    <title>AppSecD_Report - {_html_escape(p.get('application_name', ''))}</title>
    <style>
        @page {{ margin: 2cm; }}
...
<body>
    ...
    <div class="doc-control">
        ...
        Report Version: 1.0 | Generated: {gen} | Prepared by: AppSecD
    </div>
...
"""
    footer_prefix = f'<p class="meta">Report generated by AppSecD at {gen}. This document is confidential. Integrity: SHA-256: '
    content_to_hash = html + footer_prefix
    report_hash = hashlib.sha256(content_to_hash.encode("utf-8")).hexdigest()
    html += footer_prefix + report_hash + "</p>\n</body>\n</html>\n"
    return html
...
def generate_docx(data: dict) -> bytes:
    ...
    doc.add_heading("Application Security Assessment Report", 0)
    ...
    doc.add_paragraph(f"Report generated by AppSecD at {data['generated_at']}")
...
def generate_pdf(data: dict) -> bytes:
    ...
    class ReportPDF(FPDF):
        def header(self):
            ...
            self.cell(0, 8, "AppSecD Security Assessment Report", ln=True, align="C")
